...
public class CreateAccountViaFacebookResponseEvent extends PreDatabaseResponseEvent{

    private CreateAccountResponseProto createAccountResponseProto;

    public CreateAccountViaFacebookResponseEvent(String udid) {
	super(udid);
	eventType = CommonEventProtocolResponse.S_CREATE_ACCOUNT_VIA_FACEBOOK_EVENT_VALUE;
    }
