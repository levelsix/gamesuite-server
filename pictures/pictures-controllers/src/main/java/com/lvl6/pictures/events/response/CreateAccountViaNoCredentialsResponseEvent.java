...
public class CreateAccountViaNoCredentialsResponseEvent extends PreDatabaseResponseEvent{

  private CreateAccountResponseProto createAccountResponseProto;
  
  public CreateAccountViaNoCredentialsResponseEvent(String udid) {
    super(udid);
    eventType = CommonEventProtocolResponse.S_CREATE_ACCOUNT_VIA_NO_CREDENTIALS_EVENT_VALUE;
  }
